        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a
              ...
              href="#pagesConfigurations"
              class="nav-link"
              aria-controls="pagesConfigurations"
              role="button"
              aria-expanded="false"
            >
              <div
            ...
            <div class="collapse" id="pagesConfigurations">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="pagesInventory">
              <ul class="nav ms-4 ps-3">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="pagesPurchase">
              <ul class="nav ms-4 ps-3">
